...
export interface ChiSono { uid: string | null; nome: string | null; ruolo: 'ceo' | 'coordinamento'; ruoloVero: string; reparto: string | null; pod: Persona[]; concessi: Chiave[]; vista: { id: string; nome: string | null } | null }
