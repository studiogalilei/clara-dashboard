...
export const WIDGET: Widget[] = [
  ...
  { chiave: 'prospect', nome: 'Aziende', cosa: 'Prospect e clienti: bacheca, foglio, preventivi', zona: 'menu', fisso: true, base: true,
    ruoli: ['ceo', 'coordinamento'],
    icona: 'M8 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM2 21c0-3.3 2.7-6 6-6s6 2.7 6 6M17 8a3 3 0 1 0 0-6M22 21c0-2.8-1.9-5.1-4.5-5.8' },
  { chiave: 'progetti', nome: 'Progetti', cosa: 'Il foglio dei progetti di Giacomo: prova, retainer, siti, scadenze', zona: 'menu', fisso: true,
    ruoli: ['ceo', 'coordinamento'],
  ...
  { chiave: 'clara', nome: 'Clara', cosa: 'Le cose che chiede, e la chat', zona: 'menu', fisso: true, base: true,
    ruoli: ['ceo', 'coordinamento'],
