...
import { WIDGET, NOME_RUOLO, haAccesso, type Chiave, type Ruolo } from './widget'
...
const COSA: Partial<Record<Chiave, string>> = {
  ...
  clara: 'Quello che Clara ha preparato per te: bozze da approvare, domande, avanzamenti. Una bozza approvata la manda lei da Smartlead, com\'è nel riquadro.',
...
const PAROLE: Array<[string, string]> = [
  ...
  ['Posta di Clara', 'La cassetta delle cose che Clara propone: bozze, domande, avanzamenti. Non decide niente da sola: propone, tu approvi o dici no.'],
  ['Approva e manda', 'Il bottone sotto una bozza. La bozza, com\'è nel riquadro, parte da Smartlead nel thread della persona, con la firma della casella e l\'analisi in allegato la prima volta. «Non così» con il motivo, e Clara la riscrive.'],
  ['Sincronizza', 'Clara rilegge Smartlead, il calendario e la posta e aggiorna tutto. Lo fa da sola ogni cinque minuti; il bottone in alto lo fa adesso, e la riga accanto dice quando è stata l\'ultima.'],
  ['Classificazione', 'Come ha risposto un\'azienda: Caldo, Tiepido, No, Rinviato, Fuori ufficio, Fuori target, Non contattare, Da capire. La stessa parola nella bacheca e nella scheda.'],
  ['Blocco dopo la call', 'Dopo una call Clara legge gli appunti, sposta la carta se in call è stato deciso il passo, e mette in calendario mezz\'ora «Clara: dopo la call con X» con le cose da fare, lo stesso giorno.'],
...
// con la voce di Clara: le stesse frasi le dice lei nel giro guidato e
...
export function guidaDi(chi: Chi): Documento {
  ...
  b.push({ tipo: 'p', testo: 'Si scrive nella chat della pallina, come si scriverebbe a una persona. Qui lo dice lei, con parole sue: queste le fa già oggi.' })
