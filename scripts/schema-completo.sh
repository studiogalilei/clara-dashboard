...
ordine=(schema.sql schema_v2.sql schema_v3.sql schema_v4.sql schema_v5.sql schema_v5b.sql schema_v6.sql schema_v7.sql schema_v8.sql schema_v9.sql schema_v10 schema_v11 schema_v12 schema_v13.sql)
mancanti=()
